      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-white/50 mt-2">
            Join the best trading community on the internet
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/[0.06] to-white/[0.02] backdrop-blur-xl p-6 sm:p-8">
          <Tabs value={mode} onValueChange={(v) => { setMode(v as 'login' | 'signup'); setError(null); }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="email" className="text-sm font-medium text-white/70 block mb-1.5">
                  Email
                </label>
                <Input
                  id="email"
              ...
              <div>
                <label htmlFor="password" className="text-sm font-medium text-white/70 block mb-1.5">
                  Password
                </label>
              ...
              {mode === 'signup' && (
                <div>
                  <label htmlFor="confirmPassword" className="text-sm font-medium text-white/70 block mb-1.5">
                    Confirm Password
                  </label>
                  <Input
                    id="confirmPassword"
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-gray-900 px-2 text-white/30">or continue with</span>
              </div>
            </div>
